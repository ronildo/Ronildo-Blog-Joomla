...
<h2 class="contentheading<?php echo $this->item->params->get('pageclass_sfx'); ?>">
	<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
		<a href="<?php echo $this->item->readmore_link; ?>" title="<?php echo $this->escape($this->item->title); ?>" class="contentpagetitle<?php echo $this->item->params->get('pageclass_sfx'); ?>">
...
<div class="moreInfoWrapper">
	...
	<div class="posiciona-moreinfo posiciona-cateory">
		<div class="moreInfo">
