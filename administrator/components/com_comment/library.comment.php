...
<table class="adminheading" cellpadding="4" cellspacing="0" border="0">
    <tr>
		<td>
			<img src="./../components/com_comment/joscomment/images/joomlacommentlogo.png">
		</td>
		<td>
            <p>Congratulations! Joomlacomment 4.0 RC1 has been successfuly installed
                on your system. Please go to your joomla front end and post a comment
                to see how Joomlacomment works. If you wish to customize the component
                please return at the settings page.</p>
            <p><b>If you wish to support the project please make a donation</b></p>

			<form method="post" action="https://www.paypal.com/cgi-bin/webscr">
				<div>
					<input type="hidden" value="_donations" name="cmd" />
					<input type="hidden" value="danielsd_bg@yahoo.fr" name="business" />
					<input type="hidden" value="Support compojoom and !joomlacomment" name="item_name" />
			...
			<p><b>PROBLEMS????</b> Visit <a href="http://compojoom.com">compojoom.com</a> and ask for help!</p>
			<p><br /><b>!JoomlaComment 4.0 RC1 by Compojoom.com - <a target="_blank" href="http://compojoom.com">http://compojoom.com</a></b>
				<br />
				<br />Copyright (C) 2008-<?php echo date('Y'); ?> Compojoom.com . All rights reserved.
