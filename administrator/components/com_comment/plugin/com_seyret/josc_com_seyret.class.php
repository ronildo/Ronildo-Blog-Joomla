...
class JOSC_com_seyret extends JOSC_component {
	...
	$rss->useCached("RSS2.0", JPATH_SITE. DS .'components'.DS. 'com_comment'.DS.'seyretfeed.xml');
	...
	$rss->saveFeed("RSS2.0", JPATH_SITE. DS .'components'.DS. 'com_comment'.DS.'seyretfeed.xml');
    }
