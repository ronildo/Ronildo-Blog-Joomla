...
class JOSC_com_eventlist extends JOSC_component {
	...
	//	$rss->useCached("RSS2.0", JPATH_SITE. DS .'components'.DS. 'com_comment'.DS.'josceventlistfeed.xml');
	...
	$rss->saveFeed("RSS2.0", JPATH_SITE. DS .'components'.DS. 'com_comment'.DS.'josceventlistfeed.xml');
    }
