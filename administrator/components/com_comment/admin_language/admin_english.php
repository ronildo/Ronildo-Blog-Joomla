...
JOSC_define('_JOOMLACOMMENT_ADMIN_date_format_HELP', 'The syntax used is identical to the PHP strftime() function.');
...
/* ADDED SINCE 4.0 */
/* AKISMET SUPPORT */
JOSC_define('_JOOMLACOMMENT_ADMIN_akismet_use', 'Use akismet spam protection');
JOSC_define('_JOOMLACOMMENT_ADMIN_akismet_HELP', 'Akismet is a web service that help greatly to reduce spam. Check it under <a href="http://www.akismet.com" target="_blank">akismet.com</a>');
JOSC_define('_JOOMLACOMMENT_ADMIN_akismet_key', 'Your akismet key:');
JOSC_define('_JOOMLACOMMENT_ADMIN_akismet_key_HELP','You can get a free personal key under:<a href="http://akismet.com/personal/" target="_blank">free personal key</a> ');
/*GRAVATAR SUPPORT */
JOSC_define('_JOOMLACOMMENT_ADMIN_gravatar_CAPTION', 'Enable gravatar support:');
JOSC_define('_JOOMLACOMMENT_ADMIN_gravatar_HELP', 'Use <a href="http://gravatar.com" target="blank">gravatar</a> avatar webservice');

/*disable comment form */
JOSC_define('_JOOMLACOMMENT_ADMIN_disable_additional_comments_CAPTION', 'Disable additional comments');
JOSC_define('_JOOMLACOMMENT_ADMIN_disable_additional_comments_HELP', 'Disable the comment form for the spcified content id');
?>
